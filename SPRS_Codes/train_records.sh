...
scp ada:/share1/$USER/SPRS/record.zip /scratch/$USER/
unzip /scratch/$USER/record.zip -d /scratch/$USER/

cd /home2/$USER/resp_sound/codes

mkdir -p /scratch/$USER/model_checkpoints_SPRS/record_classification/vgg16

python main_train_records.py
